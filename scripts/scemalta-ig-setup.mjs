...
//
//   node scripts/scemalta-ig-setup.mjs --app-id 123 --app-secret abc --token EAAB...
//
...
if (!appId || !appSecret || !token) {
  console.error('Uso: node scripts/scemalta-ig-setup.mjs --app-id ID --app-secret SEGREDO --token TOKEN_CURTO')
  process.exit(1)
}
